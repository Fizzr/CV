...
\end{itemize}
 			 ...
 			 %Ansiktet utåt för Academic Work,  arbetar för att upprätthålla märket ``Academic Work ''och ``Home of the Young Professional'' gentemot studenter. Yrket kräver att kommunicera utan förhinder med kunder och kollegor, att både jobba tätt i grupp och väldigt självständigt, samt att alltid uppträda professionellt.}	\\
%			&						\\
